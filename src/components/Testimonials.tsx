...
const Testimonials = () => {
  ...
  return (
    <section id="testimonios" className="py-20 md:py-24 bg-dark-gray anchor-section">
        ...
        <div className="max-w-5xl mx-auto relative">
          ...
          <div className="hidden md:flex absolute top-1/2 -left-12 transform -translate-y-1/2 z-10">
            <button 
              ...
              className="p-2 rounded-full bg-key-green bg-opacity-10 text-key-green hover:bg-opacity-20 transition-all"
            >
              <ChevronLeft size={24} />
            </button>
          </div>
              ...
              {testimonialsList.map((_, index) => (
                <button
                  ...
                  className={`w-2.5 h-2.5 rounded-full transition-all ${
                    index === activeIndex ? 'bg-key-green' : 'bg-gray-500'
                  }`}
                />
              ))}
            </div>
